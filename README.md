...
Y `Band#initialize(name, hometown)`
...
Y `Concert#initialize(date, band, venue)`
...
Y `Concert#hometown_show?`
  - returns `true` if the concert is in the band's hometown, `false` if it is not
Y `Concert#introduction`
